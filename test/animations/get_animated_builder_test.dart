...
void main() {
  ...
  group('BlurAnimation image filtering', () {
  ...
  group('GetAnimatedBuilder configuration updates and autoPlayOnUpdate', () {
    ...
    testWidgets(
      'GetAnimatedBuilder replays from the beginning when tween changes and autoPlayOnUpdate is true',
      (WidgetTester tester) async {
        Widget buildAnimation(double tweenEnd) {
          return _Wrapper(
            child: GetAnimatedBuilder<double>(
    ...
    testWidgets(
      'rebuild with an identical tween does not replay even with autoPlayOnUpdate enabled',
      (WidgetTester tester) async {
        var buildCount = 0;
    ...
    testWidgets(
      'default behavior without autoPlayOnUpdate snaps to new tween end without replaying',
      (WidgetTester tester) async {
        Widget buildAnimation(double tweenEnd) {
          return _Wrapper(
            child: GetAnimatedBuilder<double>(
    ...
    testWidgets(
      'scale() extension inside Obx replays when observed value changes',
      (WidgetTester tester) async {
